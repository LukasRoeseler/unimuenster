...
<body>
  <h1>${reportTitle}</h1>
  <p class="generated">Generated by the <a href="https://lukasroeseler.github.io/unimuenster/publication-costs/">Publication Cost Calculator</a> on ${new Date().toLocaleString()}.</p>
  ${
    candidateOrcidId
